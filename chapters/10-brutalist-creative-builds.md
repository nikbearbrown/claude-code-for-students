...
Seth had a chart to make for the school newspaper. The data was the district's high-school dropout rate, year by year, 2010 through 2025. The point of the chart was to argue that the rate had risen in 2020–2022 — a pandemic spike — and then come down, but not all the way down. Same Claude. Same data file. Same technical request: render a line chart of dropout rate, 2010 to 2025, with annotations. What differed was the framework around the request.

**Build one: prompt only.** Seth opened Claude and typed: *render a clean line chart showing the high school dropout rate from 2010 to 2025; annotate the 2020 spike; make it look professional.* Claude produced a chart in about ninety seconds. Vega-Lite. The line teal-blue. The annotation arrow soft orange. The font Inter. Zero-based y-axis. Title bold and centered. The chart looked good. Seth shipped it. The editor approved. It appeared in the paper.

Two days later, in critique, the design teacher asked him why the spike was orange. Seth said that's what came back. She asked why the line was teal-blue instead of the school newspaper's masthead red. He said that's what came back. She asked why the y-axis started at zero instead of at the lowest observed value, which would have made the rise look more dramatic and more honest. He said that's how Claude did it. She told him, gently, that he had not made a chart. He had *received* a chart.
...
Claude refused once: the DESIGN.md said axis starts at the lowest observed value rounded down, and Claude flagged that the lowest observed value in the dataset was 4.1% — should the axis start at 4%, or round further down to 3% for visual breathing room? Seth answered: 4%. Claude proceeded. The chart rendered in about ninety seconds, same as before. The line was red. The annotation pointed in black to 2021. The axis ran from 4% to 9%. The spike, at 8.4% in 2021, dominated the chart vertically; the partial recovery to 6.2% in 2025 was still visibly above the 2010–2019 baseline of around 4.5%. The argument the chart made was the argument the Intent Layer said it should make.
